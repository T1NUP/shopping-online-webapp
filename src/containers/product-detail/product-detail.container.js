                  ...
                  <div className="info-product">
                    <div className="item images-product">
                      <div className="gallery d-flex h-100 flex-column">
                        <Gallery
                          images={product.arrImage}
                          currentImage={product.nameImage}
                        />
                      </div>
                    ...
                    <div className="item infomation">
                      ...
                      <div className="add-to-cart">
                        ...
                        <button type="submit" className=" ml-3 btn-send">
                          Add to cart
                        </button>
                      </div>
                      <hr />
                      <div className="reviews">
                        ...
                        <div className="total-review d-inline color-oranges">
                          <span className="border-right  pl-4 pr-2 ">
                            {product.comments
                              ? product.comments.length + " reviews"
                              : "0 reviews"}
                          </span>
                          <a href="#write-review" className="color-oranges">
                            ...
                            {!product.comments
                              ...
                              : product.comments.map((item, index) => (
                                  <div key={index}>
                                    ...
                                    <div className="comment">{item.review}</div>
                                    <hr />
                                  </div>
                                ))}
                          </div>
